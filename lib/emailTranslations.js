...
const EMAIL_TRANSLATIONS = {
  en: {
    ...
    'welcome.html': '<h2>Welcome to Atlas Panama!</h2><p>Your subscription for <strong>{displayName}</strong> is now active. We check Panama\'s Registro Público every single day — but to keep your inbox light, we only send a routine update weekly. If anything actually changes, though, we email you right away, regardless of that schedule.</p><p>We hope you find this valuable. If you do, we\'d really appreciate you recommending us to a friend or colleague — they can sign up here: <a href="{subscribeUrl}">{subscribeUrl}</a></p><p>Thank you for being one of our first subscribers!<br>— Atlas Panama</p>',
