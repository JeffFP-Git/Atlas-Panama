...
const EMAIL_TRANSLATIONS = {
  en: {
    ...
    'welcome.text': 'Welcome to Atlas Panama!\n\nYour subscription for {displayName} is now active. We\'ll check Panama\'s Registro Público daily and email you every day — whether something changed or not — so you always know monitoring is working.\n\nWe hope you find this valuable. If you do, we\'d really appreciate you recommending us to a friend or colleague — they can sign up here: {subscribeUrl}\n\nThank you for being one of our first subscribers!\n— Atlas Panama',
    'welcome.html': '<h2>Welcome to Atlas Panama!</h2><p>Your subscription for <strong>{displayName}</strong> is now active. We\'ll check Panama\'s Registro Público daily and email you every day — whether something changed or not — so you always know monitoring is working.</p><p>We hope you find this valuable. If you do, we\'d really appreciate you recommending us to a friend or colleague — they can sign up here: <a href="{subscribeUrl}">{subscribeUrl}</a></p><p>Thank you for being one of our first subscribers!<br>— Atlas Panama</p>',
  ...
  es: {
    ...
    'welcome.text': '¡Bienvenido a Atlas Panama!\n\nSu suscripción para {displayName} ya está activa. Revisaremos el Registro Público de Panamá todos los días y le enviaremos un correo diario — haya cambios o no — para que siempre sepa que el monitoreo está funcionando.\n\nEsperamos que esta suscripción le sea de valor. Si es así, le agradeceríamos mucho que nos recomiende a un amigo o colega — puede suscribirse aquí: {subscribeUrl}\n\n¡Gracias por ser uno de nuestros primeros suscriptores!\n— Atlas Panama',
    'welcome.html': '<h2>¡Bienvenido a Atlas Panama!</h2><p>Su suscripción para <strong>{displayName}</strong> ya está activa. Revisaremos el Registro Público de Panamá todos los días y le enviaremos un correo diario — haya cambios o no — para que siempre sepa que el monitoreo está funcionando.</p><p>Esperamos que esta suscripción le sea de valor. Si es así, le agradeceríamos mucho que nos recomiende a un amigo o colega — puede suscribirse aquí: <a href="{subscribeUrl}">{subscribeUrl}</a></p><p>¡Gracias por ser uno de nuestros primeros suscriptores!<br>— Atlas Panama</p>',
